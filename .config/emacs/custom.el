(custom-set-variables
 ...
 '(package-selected-packages
      '(astro-ts-mode avy corfu diff-hl dired-preview docker
           dwim-shell-command eglot eldoc-box embark-consult
           evil-collection evil-mc evil-numbers
           ...
           svelte-ts-mode trashed typst-preview typst-ts-mode
 ...
 '(package-vc-selected-packages
      '((gnome-accent-theme-switcher :url
           ...
           (vue-ts-mode :url
               "https://github.com/theschmocker/vue-ts-mode.git")
           (svelte-ts-mode :url
